package com.yh.line.chat.data.util;
...
public class JsonUtil {
    ...
    public static String beanToJson(Object obj) {
        ...
        try {
            ...
            logger.error("convert json error " + obj.toString(), e);
        }
        return json;
    }
    ...
    public static String findValue(String resData, String resPro) {
        ...
        try {
            ...
            result = JsonUtil.beanToJson(resProNode);
        } catch (Exception e) {
            logger.error("convert json error" + resData, e);
        }
        return result;
    }
}
